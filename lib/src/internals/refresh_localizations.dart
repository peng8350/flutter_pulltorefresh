...
class RefreshLocalizationsDelegate
  ...
  @override
  bool isSupported(Locale locale) {
    return ['en', 'zh', 'fr', 'ru', 'uk', 'ja', 'it', 'de', 'nl']
...
class NlRefreshString implements RefreshString {
  ...
  @override
  String canRefreshText = "Laat los om te verversen";

  @override
  String canTwoLevelText = "Laat los om de tweede verdieping te betreden";
  
  @override
  String idleLoadingText = "Trek naar boven om meer te laden";

  @override
  String idleRefreshText = "Trek naar beneden om te vernieuwen";
  ...
  @override
  String noMoreText = "Geen gegevens meer";
