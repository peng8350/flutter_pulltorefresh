...
class _CustomHeaderExampleState extends State<CustomHeaderExample> with TickerProviderStateMixin{
  ...
  void _onOffsetChange(bool up,double offset){
    if(up&&(_refreshController.headerStatus==RefreshStatus.idle||_refreshController.headerStatus==RefreshStatus.canRefresh)){
  ...
  Widget build(BuildContext context) {
    ...
    return Container(child: SmartRefresher(
